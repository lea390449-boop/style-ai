...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Alta — Your AI Fashion Stylist" },
      { name: "description", content: "Chat with Alta, your AI stylist. Build outfits from your wardrobe, try on looks virtually, and shop curated picks." },
      { property: "og:title", content: "Alta — Your AI Fashion Stylist" },
      { property: "og:description", content: "Personal AI stylist, virtual try-on, and a beautifully curated closet." },
    ],
